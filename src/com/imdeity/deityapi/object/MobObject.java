...
public class MobObject {
    ...
    public net.minecraft.server.v1_5_R3.PathPoint getPathPoint(int x, int y, int z) {
        return new net.minecraft.server.v1_5_R3.PathPoint(x, y, z);
    }
    
    public void moveCreatureToMultiplePoint(CraftCreature entity, net.minecraft.server.v1_5_R3.PathPoint[] points) {
        entity.getHandle().setPathEntity(new net.minecraft.server.v1_5_R3.PathEntity(points));
    }
    
    public void moveCreatureToSinglePoint(CraftCreature entity, int x, int y, int z) {
        entity.getHandle().setPathEntity(new net.minecraft.server.v1_5_R3.PathEntity(new net.minecraft.server.v1_5_R3.PathPoint[] { new net.minecraft.server.v1_5_R3.PathPoint(x, y, z) }));
    }
